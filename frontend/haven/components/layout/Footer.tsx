...
import {LuBuilding2, LuCheck, LuLifeBuoy, LuShieldCheck} from "react-icons/lu";
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-12">
                    ...
                    <div className="lg:col-span-2">
                        ...
                        <div className="space-y-3">
                            <p className="font-semibold text-white">Subscribe for exclusive deals</p>

                            <form className="md:flex md:gap-2" onSubmit={(e) => e.preventDefault()}>
                                <input
                                    type="email"
                                    placeholder="Enter your email"
                                    suppressHydrationWarning
                                    className="md:flex-1 mb-3 md:mb-0 px-4 py-2.5 bg-slate-800 border border-slate-700 rounded-lg md:text-sm focus:outline-none focus:border-teal-500 transition-colors text-white placeholder-slate-500 w-full md:w-auto"
                                />
                                <button
                                    type="submit"
                                    suppressHydrationWarning
                                    className=" px-4 py-2.5 bg-teal-600 hover:bg-teal-700 text-white rounded-lg md:text-sm font-medium transition-colors w-full md:w-auto"
                                >
                                    Subscribe
                                </button>
                            </form>
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <div className="flex items-center gap-3 flex-wrap">
                                {paymentMethods.map((payment) => (
                                    <div
                                        className="h-8 px-3 bg-slate-800 rounded flex items-center gap-1.5 text-xs font-medium text-white"
                                        key={payment}>
